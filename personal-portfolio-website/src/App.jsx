...
const projects = [
  ...
  },
  {
    ...
    status: "Next Project Slot",
    href: "#travel",
    image: fieaPreview,
    imageAlt: "Fiea Travel Brand Preview",
    tags: ["Content Creation", "Photography", "Branding"],
    description:
      "A temporary project slot for the Fiea travel and storytelling brand, ready to be replaced when the next build begins.",
    action: "View Travel Section",
  },
  {
    ...
    description:
      "A temporary project slot highlighting the interactive gallery until a new project takes its place.",
    action: "View Gallery",
  },
];
...
function App() {
  ...
  const navLinkClass =
    "text-zinc-400 transition-all duration-300 hover:-translate-y-0.5 hover:text-[#D4A574] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#D4A574]";
  ...
  useEffect(() => {
    const handleKeyDown = (e) => {
      ...
      if (e.key === "ArrowLeft" && selectedImage && selectedIndex !== null) {
        const newIndex =
          selectedIndex === 0
            ? photos.length - 1
            : selectedIndex - 1;
      ...
      if (e.key === "ArrowRight" && selectedImage && selectedIndex !== null) {
        const newIndex =
  ...
  return (
    ...
    >
      {/* Navbar */}
      <nav className="fixed top-0 z-50 w-full border-b border-white/10 bg-black/85 shadow-lg shadow-black/20 backdrop-blur-md">
          ...
          {photos.map(
            (photo, index) => (
              <motion.button
                ...
                aria-label={`Open photography ${index + 1}`}
        ...
        {selectedImage && selectedIndex !== null && (
          ...
          >
            ...
            <button
              ...
              className="absolute left-4 inline-flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-white/10 text-white shadow-lg shadow-black/30 backdrop-blur-md transition hover:border-[#D4A574]/50 hover:bg-[#D4A574]/10 hover:text-[#D4A574] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#D4A574] md:left-8"
            >
            ...
            <button
              ...
              className="absolute right-4 inline-flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-white/10 text-white shadow-lg shadow-black/30 backdrop-blur-md transition hover:border-[#D4A574]/50 hover:bg-[#D4A574]/10 hover:text-[#D4A574] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#D4A574] md:right-8"
            >
